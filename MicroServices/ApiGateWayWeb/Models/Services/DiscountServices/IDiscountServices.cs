...
using APiGatWayWebApi.Models.Dtos;
using DiscountServices.Protos;
using Grpc.Net.Client;

namespace APiGatWayWebApi.Models.Services.DiscountServices
{
    ...
    public class DiscountServices : IDiscountServices
    {
        ...
        public DiscountServices(GrpcChannel grpc, IConfiguration configuration)
        {
