...
public class Index : PageModel
{
    ...
    public async Task<IActionResult> OnPost()
    {
        ...
        if (_user.FindByNameAsync(Input.Username) != null)
        {
        ...
        if (ModelState.IsValid)
        {
            ...
            var user1 = _user.CreateAsync(newUser, Input.Password).Result;
                //(Input.Username, Input.Password, Input.Name, Input.Email).Result;
            var user = _user.FindByNameAsync(Input.Username).Result;
