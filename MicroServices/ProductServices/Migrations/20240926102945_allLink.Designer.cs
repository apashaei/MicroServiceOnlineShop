...
namespace ProductServices.Migrations
{
    ...
    [Migration("20240926102945_allLink")]
            ...
            modelBuilder.Entity("ProductServices.Models.Entities.Brand", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        ...
                        .HasDefaultValue(new DateTime(2024, 9, 26, 12, 29, 45, 813, DateTimeKind.Local).AddTicks(2288));
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("05904e6e-136a-46d4-a56d-2217f1a28b9e"),
                            Description = "محصولات Apple",
                            Name = "Apple"
                        },
                        new
                        {
                            Id = new Guid("3e2837e7-9b69-4079-a393-ab93095ec395"),
                            Description = "محصولات Sumsung",
                            Name = "Sumsung"
                        },
                        new
                        {
                            Id = new Guid("b0017758-1af3-4403-8a06-72f08ca217b6"),
            ...
            modelBuilder.Entity("ProductServices.Models.Entities.CategoryComponent", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 9, 26, 12, 29, 45, 813, DateTimeKind.Local).AddTicks(5670));
            ...
            modelBuilder.Entity("ProductServices.Models.Entities.Discount", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 9, 26, 12, 29, 45, 813, DateTimeKind.Local).AddTicks(5926));
            ...
            modelBuilder.Entity("ProductServices.Models.Entities.Images", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 9, 26, 12, 29, 45, 813, DateTimeKind.Local).AddTicks(6739));
            ...
            modelBuilder.Entity("ProductServices.Models.Entities.Product", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 9, 26, 12, 29, 45, 813, DateTimeKind.Local).AddTicks(7591));
            ...
            modelBuilder.Entity("ProductServices.Models.Entities.ProductFeatures", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 9, 26, 12, 29, 45, 813, DateTimeKind.Local).AddTicks(8733));
